...
adb shell  msg_center_test -t AC/SeatHeating/FrontRight  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatHeating/RearLeft  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatHeating/RearRight  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatVentilation/FrontLeft  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatVentilation/FrontRight  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatVentilation/RearLeft  '{"value":-1}'

adb shell  msg_center_test -t AC/SeatVentilation/RearRight  '{"value":-1}'
...
adb shell  msg_center_test -t AC/Fragrance/WorkStatus1  '{"value":-1}'
adb shell  msg_center_test -t AC/Fragrance/WorkStatus2  '{"value":-1}'
adb shell  msg_center_test -t AC/Fragrance/WorkStatus3  '{"value":-1}'

adb shell  msg_center_test -t AC/WindLevel/Second  '{"value":-1}'
adb shell  msg_center_test -t AC/WindLevel/Third  '{"value":-1}'
  adb shell  msg_center_test -t AC/StayMode  '{"value":-1}'
  
  adb shell  msg_center_test -t AC/StayModeDisplay  '{"value":-1}'
